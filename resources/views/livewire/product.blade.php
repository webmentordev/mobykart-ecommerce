<section class="w-full">
    <div class="max-w-7xl m-auto w-full py-6 px-4 980px:max-w-3xl">
        ...
        <div class="grid grid-cols-2 gap-12 mb-6 980px:grid-cols-1">
            ...
            <div class="w-full">
                ...
                <div class="grid grid-cols-3 gap-6 border-b border-gray-200 mt-6 w-full pb-6 mb-3 440px:grid-cols-2" x-data="{ open : false }">
                    ...
                    <button wire:click='addToCart' class="bg-black text-white py-2 px-4 rounded-full font-semibold 440px:col-span-2">Add to Cart</button>
                    <button x-on:click="open = true" class="bg-red-600 text-white py-2 px-4 rounded-full font-semibold 440px:col-span-2">Buy Now</button>
