<footer class="bg-gray-100">
    <div class="max-w-7xl m-auto py-12 px-4 grid grid-cols-4 gap-6 1000px:grid-cols-3 680px:grid-cols-1">
        ...
        <ul class="flex flex-col">
            ...
            <a class="capitalize text-gray-600 mb-3 hover:text-red-600 text-sm" href="{{ route('contact') }}">Contact Us</a>
            <a class="capitalize text-gray-600 mb-3 hover:text-red-600 text-sm" href="{{ route('track.order') }}">Track your Order</a>
            <a class="capitalize text-gray-600 mb-3 hover:text-red-600 text-sm" href="{{ route('return') }}">Return policy</a>
            <a class="capitalize text-gray-600 mb-3 hover:text-red-600 text-sm" href="{{ route('privacy') }}">Privacy Policy</a>
            <a class="capitalize text-gray-600 mb-3 hover:text-red-600 text-sm" href="{{ route('terms') }}">Terms of service</a>
        </ul>
        <ul class="flex flex-col">
